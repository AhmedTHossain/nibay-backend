...
const FAQ_ITEMS = [
  {
    id: "1",
    title: "কিভাবে আমি চাকরির জন্য আবেদন করব?",
    text: "আবেদনের জন্য, প্রথমে চাকরির বিবরণ স্ক্রীনে যান চাকরির তালিকায় ট্যাপ করে। তারপর, 'আবেদন করুন' বোতামে ট্যাপ করুন এবং আপনার আবেদন সম্পূর্ণ করতে সমস্ত প্রয়োজনীয় নথি আপলোড করুন।"
  },
  {
    id: "2",
    title: "বিভিন্ন আবেদন স্ট্যাটাসের অর্থ কী?",
    text: "আমি কি চাকরির আপডেটের জন্য কোম্পানিগুলোকে অনুসরণ করতে পারি? আমি কিভাবে আমার প্রোফাইল রেটিং এবং নিয়োগকর্তাদের মন্তব্য দেখতে পারি যদি আমাকে অ্যাপটি ব্যবহার করতে সাহায্য প্রয়োজন হয়, তাহলে আমি কি করব?"
  }
];

export default function TermsOfServicesRoute() {
  return (
    <>
      <Header />
      <HeroSection title="শর্তাবলী এবং নীতিমালা" />
